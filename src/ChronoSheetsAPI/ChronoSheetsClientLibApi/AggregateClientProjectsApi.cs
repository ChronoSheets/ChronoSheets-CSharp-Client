...
namespace ChronoSheetsAPI.ChronoSheetsClientLibApi
{
    ...
    public interface IAggregateClientProjectsApi : IApiAccessor
    {
        ...
        /// <returns>ApiResponseListAggregateClient</returns>
        ...
        /// <exception cref="ChronoSheetsAPI.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="xChronosheetsAuth">The ChronoSheets Auth Token</param>
        /// <returns>ApiResponse of ApiResponseListAggregateClient</returns>
        ApiResponse<ApiResponseListAggregateClient> AggregateClientProjectsGetAggregateClientProjectsWithHttpInfo (string xChronosheetsAuth);
    ...
    public partial class AggregateClientProjectsApi : IAggregateClientProjectsApi
    {
        ...
        /// <param name="xChronosheetsAuth">The ChronoSheets Auth Token</param>
        /// <returns>ApiResponseListAggregateClient</returns>
        public ApiResponseListAggregateClient AggregateClientProjectsGetAggregateClientProjects (string xChronosheetsAuth)
        {
             ApiResponse<ApiResponseListAggregateClient> localVarResponse = AggregateClientProjectsGetAggregateClientProjectsWithHttpInfo(xChronosheetsAuth);
        ...
        /// <param name="xChronosheetsAuth">The ChronoSheets Auth Token</param>
        /// <returns>ApiResponse of ApiResponseListAggregateClient</returns>
        public ApiResponse<ApiResponseListAggregateClient> AggregateClientProjectsGetAggregateClientProjectsWithHttpInfo (string xChronosheetsAuth)
        {
            ...
            return new ApiResponse<ApiResponseListAggregateClient>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (ApiResponseListAggregateClient) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(ApiResponseListAggregateClient)));
        }
