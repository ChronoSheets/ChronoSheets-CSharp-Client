...
namespace ChronoSheetsAPI.ChronoSheetsClientLibApi
{
    ...
    public interface IFileAttachmentsApi : IApiAccessor
    {
        ...
        ApiResponse<ApiResponseBoolean> FileAttachmentsDeleteTimesheetFileAttachmentWithHttpInfo (int fileAttachmentId, string xChronosheetsAuth);
        /// <summary>
        ...
        /// <param name="xChronosheetsAuth">The ChronoSheets Auth Token</param>
        /// <returns>ApiResponseTimesheetFileAttachment</returns>
        ...
        /// <param name="fileAttachmentId">The ID of the file attachment</param>
        /// <param name="xChronosheetsAuth">The ChronoSheets Auth Token</param>
        /// <returns>ApiResponse of ApiResponseTimesheetFileAttachment</returns>
        ApiResponse<ApiResponseTimesheetFileAttachment> FileAttachmentsGetFileAttachmentByIdWithHttpInfo (int fileAttachmentId, string xChronosheetsAuth);
        /// <summary>
        ...
        /// <returns>ApiResponseForPaginatedListTimesheetFileAttachment</returns>
        ApiResponseForPaginatedListTimesheetFileAttachment FileAttachmentsGetMyFileAttachments (DateTime startDate, DateTime endDate, string xChronosheetsAuth, int? skip = default(int?), int? take = default(int?));
        ...
        /// <param name="skip">Skip this many File attachments (optional)</param>
        /// <param name="take">Take this many File attachments (optional)</param>
        /// <returns>ApiResponse of ApiResponseForPaginatedListTimesheetFileAttachment</returns>
        ApiResponse<ApiResponseForPaginatedListTimesheetFileAttachment> FileAttachmentsGetMyFileAttachmentsWithHttpInfo (DateTime startDate, DateTime endDate, string xChronosheetsAuth, int? skip = default(int?), int? take = default(int?));
    ...
    public partial class FileAttachmentsApi : IFileAttachmentsApi
    {
        ...
        /// <returns></returns>
        public FileAttachmentsApi(ChronoSheetsAPI.Client.Configuration configuration = null)
        {
        ...
        /// <param name="xChronosheetsAuth">The ChronoSheets Auth Token</param>
        /// <returns>ApiResponseBoolean</returns>
        public ApiResponseBoolean FileAttachmentsDeleteTimesheetFileAttachment (int fileAttachmentId, string xChronosheetsAuth)
        {
             ApiResponse<ApiResponseBoolean> localVarResponse = FileAttachmentsDeleteTimesheetFileAttachmentWithHttpInfo(fileAttachmentId, xChronosheetsAuth);
        ...
        /// <param name="xChronosheetsAuth">The ChronoSheets Auth Token</param>
        /// <returns>ApiResponse of ApiResponseBoolean</returns>
        public ApiResponse<ApiResponseBoolean> FileAttachmentsDeleteTimesheetFileAttachmentWithHttpInfo (int fileAttachmentId, string xChronosheetsAuth)
        {
        ...
        /// <param name="xChronosheetsAuth">The ChronoSheets Auth Token</param>
        /// <returns>ApiResponseTimesheetFileAttachment</returns>
        public ApiResponseTimesheetFileAttachment FileAttachmentsGetFileAttachmentById (int fileAttachmentId, string xChronosheetsAuth)
        {
             ApiResponse<ApiResponseTimesheetFileAttachment> localVarResponse = FileAttachmentsGetFileAttachmentByIdWithHttpInfo(fileAttachmentId, xChronosheetsAuth);
             return localVarResponse.Data;
        }
        ...
        /// <param name="xChronosheetsAuth">The ChronoSheets Auth Token</param>
        /// <returns>ApiResponse of ApiResponseTimesheetFileAttachment</returns>
        public ApiResponse<ApiResponseTimesheetFileAttachment> FileAttachmentsGetFileAttachmentByIdWithHttpInfo (int fileAttachmentId, string xChronosheetsAuth)
        {
            // verify the required parameter 'fileAttachmentId' is set
            if (fileAttachmentId == null)
                throw new ApiException(400, "Missing required parameter 'fileAttachmentId' when calling FileAttachmentsApi->FileAttachmentsGetFileAttachmentById");
            // verify the required parameter 'xChronosheetsAuth' is set
            if (xChronosheetsAuth == null)
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("FileAttachmentsGetFileAttachmentById", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<ApiResponseTimesheetFileAttachment>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (ApiResponseTimesheetFileAttachment) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(ApiResponseTimesheetFileAttachment)));
        }
        ...
        /// <param name="take">Take this many File attachments (optional)</param>
        /// <returns>ApiResponseForPaginatedListTimesheetFileAttachment</returns>
        public ApiResponseForPaginatedListTimesheetFileAttachment FileAttachmentsGetMyFileAttachments (DateTime startDate, DateTime endDate, string xChronosheetsAuth, int? skip = default(int?), int? take = default(int?))
        {
             ApiResponse<ApiResponseForPaginatedListTimesheetFileAttachment> localVarResponse = FileAttachmentsGetMyFileAttachmentsWithHttpInfo(startDate, endDate, xChronosheetsAuth, skip, take);
             return localVarResponse.Data;
        }
        ...
        /// <param name="take">Take this many File attachments (optional)</param>
        /// <returns>ApiResponse of ApiResponseForPaginatedListTimesheetFileAttachment</returns>
        public ApiResponse<ApiResponseForPaginatedListTimesheetFileAttachment> FileAttachmentsGetMyFileAttachmentsWithHttpInfo (DateTime startDate, DateTime endDate, string xChronosheetsAuth, int? skip = default(int?), int? take = default(int?))
        {
            ...
            return new ApiResponse<ApiResponseForPaginatedListTimesheetFileAttachment>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (ApiResponseForPaginatedListTimesheetFileAttachment) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(ApiResponseForPaginatedListTimesheetFileAttachment)));
        }
