    ...
    public partial class TripsApi : ITripsApi
    {
        ...
        public ApiResponse< CSApiResponseTrip > TripsGetMyTripByIdWithHttpInfo (int? tripId, string xChronosheetsAuth)
        {
            ...
            return new ApiResponse<CSApiResponseTrip>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (CSApiResponseTrip) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(CSApiResponseTrip)));
        }
        ...
        public ApiResponse< CSApiResponseForPaginatedListTrip > TripsGetMyTripsWithHttpInfo (DateTime? startDate, DateTime? endDate, string xChronosheetsAuth, int? skip = null, int? take = null, int? vehicleId = null)
        {
            ...
            return new ApiResponse<CSApiResponseForPaginatedListTrip>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (CSApiResponseForPaginatedListTrip) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(CSApiResponseForPaginatedListTrip)));
        }
