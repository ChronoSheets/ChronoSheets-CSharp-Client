...
namespace ChronoSheetsAPI.ChronoSheetsClientLibApi
{
    ...
    public interface IUserPayRatesApi : IApiAccessor
    {
        ...
        ApiResponse<ApiResponseInt32> UserPayRatesCreatePayRateWithHttpInfo (string xChronosheetsAuth, InsertUserHourlyRateRequest request);
        /// <summary>
        ...
        /// <param name="xChronosheetsAuth">The ChronoSheets Auth Token</param>
        /// <returns>ApiResponseListUserHourlyRate</returns>
        ...
        /// <param name="userId">The ID of the User for which you want to get UserHourlyRate objects</param>
        /// <param name="xChronosheetsAuth">The ChronoSheets Auth Token</param>
        /// <returns>ApiResponse of ApiResponseListUserHourlyRate</returns>
        ApiResponse<ApiResponseListUserHourlyRate> UserPayRatesGetPayRatesWithHttpInfo (int userId, string xChronosheetsAuth);
    ...
    public partial class UserPayRatesApi : IUserPayRatesApi
    {
        ...
        /// <returns></returns>
        public UserPayRatesApi(ChronoSheetsAPI.Client.Configuration configuration = null)
        {
        ...
        /// <param name="request">An Insert UserHourlyRate Request object containing values for the new UserHourlyRate to create</param>
        /// <returns>ApiResponseInt32</returns>
        public ApiResponseInt32 UserPayRatesCreatePayRate (string xChronosheetsAuth, InsertUserHourlyRateRequest request)
        {
             ApiResponse<ApiResponseInt32> localVarResponse = UserPayRatesCreatePayRateWithHttpInfo(xChronosheetsAuth, request);
        ...
        /// <param name="request">An Insert UserHourlyRate Request object containing values for the new UserHourlyRate to create</param>
        /// <returns>ApiResponse of ApiResponseInt32</returns>
        public ApiResponse<ApiResponseInt32> UserPayRatesCreatePayRateWithHttpInfo (string xChronosheetsAuth, InsertUserHourlyRateRequest request)
        {
        ...
        /// <param name="xChronosheetsAuth">The ChronoSheets Auth Token</param>
        /// <returns>ApiResponseListUserHourlyRate</returns>
        public ApiResponseListUserHourlyRate UserPayRatesGetPayRates (int userId, string xChronosheetsAuth)
        {
             ApiResponse<ApiResponseListUserHourlyRate> localVarResponse = UserPayRatesGetPayRatesWithHttpInfo(userId, xChronosheetsAuth);
             return localVarResponse.Data;
        }
        ...
        /// <param name="xChronosheetsAuth">The ChronoSheets Auth Token</param>
        /// <returns>ApiResponse of ApiResponseListUserHourlyRate</returns>
        public ApiResponse<ApiResponseListUserHourlyRate> UserPayRatesGetPayRatesWithHttpInfo (int userId, string xChronosheetsAuth)
        {
            ...
            return new ApiResponse<ApiResponseListUserHourlyRate>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (ApiResponseListUserHourlyRate) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(ApiResponseListUserHourlyRate)));
        }
