...
namespace ChronoSheetsAPI.ChronoSheetsClientLibApi
{
    ...
    public interface ITimesheetAutomationApi : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<CSApiResponseInt32> TimesheetAutomationCreateAutomationStepAsync (CSCreateAutomationStepRequest request, string xChronosheetsAuth);
    ...
    public partial class TimesheetAutomationApi : ITimesheetAutomationApi
    {
        ...
        /// <param name="xChronosheetsAuth">The ChronoSheets Auth Token</param>
        /// <returns>CSApiResponseInt32</returns>
        public CSApiResponseInt32 TimesheetAutomationCreateAutomationStep (CSCreateAutomationStepRequest request, string xChronosheetsAuth)
        {
             ApiResponse<CSApiResponseInt32> localVarResponse = TimesheetAutomationCreateAutomationStepWithHttpInfo(request, xChronosheetsAuth);
        ...
        /// <param name="xChronosheetsAuth">The ChronoSheets Auth Token</param>
        /// <returns>ApiResponse of CSApiResponseInt32</returns>
        public ApiResponse< CSApiResponseInt32 > TimesheetAutomationCreateAutomationStepWithHttpInfo (CSCreateAutomationStepRequest request, string xChronosheetsAuth)
        {
        ...
        /// <param name="xChronosheetsAuth">The ChronoSheets Auth Token</param>
        /// <returns>Task of CSApiResponseInt32</returns>
        public async System.Threading.Tasks.Task<CSApiResponseInt32> TimesheetAutomationCreateAutomationStepAsync (CSCreateAutomationStepRequest request, string xChronosheetsAuth)
        {
             ApiResponse<CSApiResponseInt32> localVarResponse = await TimesheetAutomationCreateAutomationStepAsyncWithHttpInfo(request, xChronosheetsAuth);
             return localVarResponse.Data;
        ...
        /// <param name="xChronosheetsAuth">The ChronoSheets Auth Token</param>
        /// <returns>Task of ApiResponse (CSApiResponseInt32)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<CSApiResponseInt32>> TimesheetAutomationCreateAutomationStepAsyncWithHttpInfo (CSCreateAutomationStepRequest request, string xChronosheetsAuth)
        {
            // verify the required parameter 'request' is set
            if (request == null)
                throw new ApiException(400, "Missing required parameter 'request' when calling TimesheetAutomationApi->TimesheetAutomationCreateAutomationStep");
