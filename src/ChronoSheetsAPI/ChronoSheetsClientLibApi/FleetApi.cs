...
namespace ChronoSheetsAPI.ChronoSheetsClientLibApi
{
    ...
    public interface IFleetApi : IApiAccessor
    {
        ...
        ApiResponse<CSApiResponseBoolean> FleetDeleteVehicleWithHttpInfo (int? vehicleId, string xChronosheetsAuth);
        /// <summary>
        ...
        System.Threading.Tasks.Task<CSApiResponseBoolean> FleetDeleteVehicleAsync (int? vehicleId, string xChronosheetsAuth);
        ...
        System.Threading.Tasks.Task<ApiResponse<CSApiResponseBoolean>> FleetDeleteVehicleAsyncWithHttpInfo (int? vehicleId, string xChronosheetsAuth);
        /// <summary>
        /// Get a particular vehicle.  Does not require any special permission.
        /// </summary>
        /// <remarks>
    ...
    public partial class FleetApi : IFleetApi
    {
        ...
        /// <param name="xChronosheetsAuth">The ChronoSheets Auth Token</param>
        /// <returns>CSApiResponseBoolean</returns>
        public CSApiResponseBoolean FleetDeleteVehicle (int? vehicleId, string xChronosheetsAuth)
        {
             ApiResponse<CSApiResponseBoolean> localVarResponse = FleetDeleteVehicleWithHttpInfo(vehicleId, xChronosheetsAuth);
             return localVarResponse.Data;
        }
        ...
        /// <param name="xChronosheetsAuth">The ChronoSheets Auth Token</param>
        /// <returns>ApiResponse of CSApiResponseBoolean</returns>
        public ApiResponse< CSApiResponseBoolean > FleetDeleteVehicleWithHttpInfo (int? vehicleId, string xChronosheetsAuth)
        {
        ...
        /// <param name="xChronosheetsAuth">The ChronoSheets Auth Token</param>
        /// <returns>Task of CSApiResponseBoolean</returns>
        public async System.Threading.Tasks.Task<CSApiResponseBoolean> FleetDeleteVehicleAsync (int? vehicleId, string xChronosheetsAuth)
        {
             ApiResponse<CSApiResponseBoolean> localVarResponse = await FleetDeleteVehicleAsyncWithHttpInfo(vehicleId, xChronosheetsAuth);
             return localVarResponse.Data;
        ...
        /// <param name="xChronosheetsAuth">The ChronoSheets Auth Token</param>
        /// <returns>Task of ApiResponse (CSApiResponseBoolean)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<CSApiResponseBoolean>> FleetDeleteVehicleAsyncWithHttpInfo (int? vehicleId, string xChronosheetsAuth)
        {
            // verify the required parameter 'vehicleId' is set
            if (vehicleId == null)
                throw new ApiException(400, "Missing required parameter 'vehicleId' when calling FleetApi->FleetDeleteVehicle");
        ...
        public ApiResponse< CSApiResponseFleetVehicle > FleetGetVehicleByIdWithHttpInfo (int? vehicleId, string xChronosheetsAuth)
        {
            ...
            return new ApiResponse<CSApiResponseFleetVehicle>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (CSApiResponseFleetVehicle) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(CSApiResponseFleetVehicle)));
        }
        ...
        public ApiResponse< CSApiResponseListFleetVehicle > FleetGetVehiclesWithHttpInfo (string xChronosheetsAuth, bool? includeDeleted = null)
        {
            ...
            return new ApiResponse<CSApiResponseListFleetVehicle>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (CSApiResponseListFleetVehicle) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(CSApiResponseListFleetVehicle)));
        }
