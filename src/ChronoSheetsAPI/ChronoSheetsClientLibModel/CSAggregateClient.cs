...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class CSAggregateClient :  IEquatable<CSAggregateClient>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CSAggregateClient" /> class.
        /// </summary>
        /// <param name="ClientProjects">ClientProjects.</param>
        ...
        /// <summary>
        /// Gets or Sets ClientProjects
        /// </summary>
        [DataMember(Name="ClientProjects", EmitDefaultValue=false)]
        public List<CSAggregateProject> ClientProjects { get; set; }
        ...
        {
            return this.Equals(input as CSAggregateClient);
        }

        /// <summary>
        /// Returns true if CSAggregateClient instances are equal
        /// </summary>
        /// <param name="input">Instance of CSAggregateClient to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CSAggregateClient input)
        {
            if (input == null)
                return false;
