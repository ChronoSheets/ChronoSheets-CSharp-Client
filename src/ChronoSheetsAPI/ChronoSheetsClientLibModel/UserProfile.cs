...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    public partial class UserProfile :  IEquatable<UserProfile>, IValidatableObject
    {
        ...
        public UserProfile(int id = default(int), int organisationId = default(int), string userName = default(string), string firstName = default(string), string lastName = default(string), string emailAddress = default(string), bool isSubscribedToNewsletter = default(bool), long roles = default(long), long alertSettings = default(long), string organisationName = default(string), string organisationSuburb = default(string), string organisationCountry = default(string))
        {
            this.Id = id;
