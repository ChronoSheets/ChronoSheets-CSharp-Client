...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class CsApiJobSeriesReportItem :  IEquatable<CsApiJobSeriesReportItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CsApiJobSeriesReportItem" /> class.
        /// </summary>
        ...
        public CsApiJobSeriesReportItem(DateTime? StartDate = default(DateTime?), DateTime? EndDate = default(DateTime?), int? JobId = default(int?), int? ClientId = default(int?), string ClientName = default(string), int? ProjectId = default(int?), string ProjectName = default(string), int? SpanSeconds = default(int?), string JobCode = default(string))
        {
        ...
        {
            return this.Equals(input as CsApiJobSeriesReportItem);
        }

        /// <summary>
        /// Returns true if CsApiJobSeriesReportItem instances are equal
        /// </summary>
        /// <param name="input">Instance of CsApiJobSeriesReportItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CsApiJobSeriesReportItem input)
        {
            if (input == null)
                return false;
