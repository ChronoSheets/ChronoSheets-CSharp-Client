...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class CsApiApiResponseForPaginatedListRawReportItem :  IEquatable<CsApiApiResponseForPaginatedListRawReportItem>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CsApiApiResponseForPaginatedListRawReportItem" /> class.
        /// </summary>
        /// <param name="TotalSetCount">TotalSetCount.</param>
        /// <param name="Data">Data.</param>
        /// <param name="Status">Status.</param>
        /// <param name="Message">Message.</param>
        public CsApiApiResponseForPaginatedListRawReportItem(int? TotalSetCount = default(int?), List<CsApiRawReportItem> Data = default(List<CsApiRawReportItem>), StatusEnum? Status = default(StatusEnum?), string Message = default(string))
        {
        ...
        public List<CsApiRawReportItem> Data { get; set; }
        ...
        {
            return this.Equals(input as CsApiApiResponseForPaginatedListRawReportItem);
        }

        /// <summary>
        /// Returns true if CsApiApiResponseForPaginatedListRawReportItem instances are equal
        /// </summary>
        /// <param name="input">Instance of CsApiApiResponseForPaginatedListRawReportItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CsApiApiResponseForPaginatedListRawReportItem input)
        {
            if (input == null)
                return false;
