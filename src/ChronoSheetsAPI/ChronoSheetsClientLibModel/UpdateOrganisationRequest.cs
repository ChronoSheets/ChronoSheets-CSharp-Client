...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateOrganisationRequest :  IEquatable<UpdateOrganisationRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateOrganisationRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UpdateOrganisationRequest);
        }

        /// <summary>
        /// Returns true if UpdateOrganisationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateOrganisationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateOrganisationRequest input)
        {
            if (input == null)
                return false;
