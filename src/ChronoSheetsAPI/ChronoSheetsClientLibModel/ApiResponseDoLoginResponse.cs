...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseDoLoginResponse :  IEquatable<ApiResponseDoLoginResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseDoLoginResponse" /> class.
        /// </summary>
        ...
        public ApiResponseDoLoginResponse(DoLoginResponse data = default(DoLoginResponse), StatusEnum? status = default(StatusEnum?), string message = default(string))
        {
            this.Data = data;
            this.Status = status;
        ...
        public DoLoginResponse Data { get; set; }
        ...
        {
            return this.Equals(input as ApiResponseDoLoginResponse);
        }

        /// <summary>
        /// Returns true if ApiResponseDoLoginResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseDoLoginResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseDoLoginResponse input)
        {
            if (input == null)
                return false;
