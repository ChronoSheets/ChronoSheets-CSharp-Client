...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class InsertUserHourlyRateRequest :  IEquatable<InsertUserHourlyRateRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InsertUserHourlyRateRequest" /> class.
        /// </summary>
        ...
        public InsertUserHourlyRateRequest(int userId = default(int), double hourlyRate = default(double), double hourlyOvertimeRate = default(double), DateTime currentDate = default(DateTime))
        {
            this.UserId = userId;
        ...
        {
            return this.Equals(input as InsertUserHourlyRateRequest);
        }

        /// <summary>
        /// Returns true if InsertUserHourlyRateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of InsertUserHourlyRateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InsertUserHourlyRateRequest input)
        {
            if (input == null)
                return false;
