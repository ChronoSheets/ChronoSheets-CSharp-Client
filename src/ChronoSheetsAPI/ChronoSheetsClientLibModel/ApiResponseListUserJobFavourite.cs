...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseListUserJobFavourite :  IEquatable<ApiResponseListUserJobFavourite>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseListUserJobFavourite" /> class.
        /// </summary>
        ...
        public ApiResponseListUserJobFavourite(List<UserJobFavourite> data = default(List<UserJobFavourite>), StatusEnum? status = default(StatusEnum?), string message = default(string))
        {
            this.Data = data;
            this.Status = status;
        ...
        public List<UserJobFavourite> Data { get; set; }
        ...
        {
            return this.Equals(input as ApiResponseListUserJobFavourite);
        }

        /// <summary>
        /// Returns true if ApiResponseListUserJobFavourite instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseListUserJobFavourite to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseListUserJobFavourite input)
        {
            if (input == null)
                return false;
