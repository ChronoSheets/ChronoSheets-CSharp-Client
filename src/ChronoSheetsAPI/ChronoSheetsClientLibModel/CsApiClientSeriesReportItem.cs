...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class CsApiClientSeriesReportItem :  IEquatable<CsApiClientSeriesReportItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CsApiClientSeriesReportItem" /> class.
        /// </summary>
        ...
        public CsApiClientSeriesReportItem(DateTime? StartDate = default(DateTime?), DateTime? EndDate = default(DateTime?), int? ClientId = default(int?), string ClientName = default(string), int? SpanSeconds = default(int?))
        {
        ...
        {
            return this.Equals(input as CsApiClientSeriesReportItem);
        }

        /// <summary>
        /// Returns true if CsApiClientSeriesReportItem instances are equal
        /// </summary>
        /// <param name="input">Instance of CsApiClientSeriesReportItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CsApiClientSeriesReportItem input)
        {
            if (input == null)
                return false;
