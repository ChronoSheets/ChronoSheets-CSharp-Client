...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class InsertOrganisationGroupRequest :  IEquatable<InsertOrganisationGroupRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InsertOrganisationGroupRequest" /> class.
        /// </summary>
        ...
        public InsertOrganisationGroupRequest(string organisationGroupName = default(string), List<int> organisationGroupUserIds = default(List<int>))
        {
        ...
        {
            return this.Equals(input as InsertOrganisationGroupRequest);
        }

        /// <summary>
        /// Returns true if InsertOrganisationGroupRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of InsertOrganisationGroupRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InsertOrganisationGroupRequest input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    input.OrganisationGroupUserIds != null &&
