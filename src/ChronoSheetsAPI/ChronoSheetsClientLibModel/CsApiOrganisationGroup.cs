...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class CsApiOrganisationGroup :  IEquatable<CsApiOrganisationGroup>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CsApiOrganisationGroup" /> class.
        /// </summary>
        /// <param name="Id">Id.</param>
        /// <param name="OrganisationId">OrganisationId.</param>
        /// <param name="OrganisationGroupName">OrganisationGroupName.</param>
        /// <param name="IsDeleted">IsDeleted.</param>
        public CsApiOrganisationGroup(int? Id = default(int?), int? OrganisationId = default(int?), string OrganisationGroupName = default(string), bool? IsDeleted = default(bool?))
        {
            this.Id = Id;
        ...
        {
            return this.Equals(input as CsApiOrganisationGroup);
        }

        /// <summary>
        /// Returns true if CsApiOrganisationGroup instances are equal
        /// </summary>
        /// <param name="input">Instance of CsApiOrganisationGroup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CsApiOrganisationGroup input)
        {
            if (input == null)
                return false;
