...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseInt32 :  IEquatable<ApiResponseInt32>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseInt32" /> class.
        /// </summary>
        ...
        public ApiResponseInt32(int data = default(int), StatusEnum? status = default(StatusEnum?), string message = default(string))
        {
            this.Data = data;
            this.Status = status;
        ...
        {
            return this.Equals(input as ApiResponseInt32);
        }

        /// <summary>
        /// Returns true if ApiResponseInt32 instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseInt32 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseInt32 input)
        {
            if (input == null)
                return false;
