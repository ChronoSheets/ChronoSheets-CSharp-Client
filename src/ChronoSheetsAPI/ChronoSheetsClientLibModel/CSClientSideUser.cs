...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class CSClientSideUser :  IEquatable<CSClientSideUser>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CSClientSideUser);
        }

        /// <summary>
        /// Returns true if CSClientSideUser instances are equal
        /// </summary>
        /// <param name="input">Instance of CSClientSideUser to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CSClientSideUser input)
        {
            if (input == null)
                return false;
