...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class CSApiResponseListProject :  IEquatable<CSApiResponseListProject>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CSApiResponseListProject" /> class.
        /// </summary>
        ...
        public CSApiResponseListProject(List<CSProject> data = default(List<CSProject>), StatusEnum? status = default(StatusEnum?), string message = default(string))
        {
            this.Data = data;
            this.Status = status;
        ...
        public List<CSProject> Data { get; set; }
        ...
        {
            return this.Equals(input as CSApiResponseListProject);
        }

        /// <summary>
        /// Returns true if CSApiResponseListProject instances are equal
        /// </summary>
        /// <param name="input">Instance of CSApiResponseListProject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CSApiResponseListProject input)
        {
            if (input == null)
                return false;
