...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class CSCreateGeoFenceRequest :  IEquatable<CSCreateGeoFenceRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CSCreateGeoFenceRequest" /> class.
        /// </summary>
        ...
        public CSCreateGeoFenceRequest(string name = default(string), List<CSBasicCoordinate> fenceCoordinates = default(List<CSBasicCoordinate>), int? triggerJobCodeId = default(int?), int? triggerTaskId = default(int?), int? sendAlertToOrgGroupId = default(int?), AlertSettingsEnum? alertSettings = default(AlertSettingsEnum?), TriggerSettingsEnum? triggerSettings = default(TriggerSettingsEnum?), int? startTimeHour = default(int?), int? startTimeMinute = default(int?), int? endTimeHour = default(int?), int? endTimeMinute = default(int?))
        {
            this.Name = name;
        ...
        {
            return this.Equals(input as CSCreateGeoFenceRequest);
        }

        /// <summary>
        /// Returns true if CSCreateGeoFenceRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CSCreateGeoFenceRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CSCreateGeoFenceRequest input)
        {
            if (input == null)
                return false;
