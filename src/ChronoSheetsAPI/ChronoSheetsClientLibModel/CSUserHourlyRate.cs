...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class CSUserHourlyRate :  IEquatable<CSUserHourlyRate>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CSUserHourlyRate);
        }

        /// <summary>
        /// Returns true if CSUserHourlyRate instances are equal
        /// </summary>
        /// <param name="input">Instance of CSUserHourlyRate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CSUserHourlyRate input)
        {
            if (input == null)
                return false;
