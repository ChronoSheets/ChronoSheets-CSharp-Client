...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class AggregateProject :  IEquatable<AggregateProject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AggregateProject" /> class.
        /// </summary>
        ...
        public AggregateProject(int id = default(int), int clientId = default(int), int organisationId = default(int), string projectName = default(string), double costEstimation = default(double), DateTime startDate = default(DateTime), DateTime endDate = default(DateTime))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as AggregateProject);
        }

        /// <summary>
        /// Returns true if AggregateProject instances are equal
        /// </summary>
        /// <param name="input">Instance of AggregateProject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AggregateProject input)
        {
            if (input == null)
                return false;
