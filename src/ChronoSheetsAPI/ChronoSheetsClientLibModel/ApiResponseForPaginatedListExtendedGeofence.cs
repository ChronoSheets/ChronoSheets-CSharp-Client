...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseForPaginatedListExtendedGeofence :  IEquatable<ApiResponseForPaginatedListExtendedGeofence>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseForPaginatedListExtendedGeofence" /> class.
        /// </summary>
        ...
        public ApiResponseForPaginatedListExtendedGeofence(int totalSetCount = default(int), List<ExtendedGeofence> data = default(List<ExtendedGeofence>), StatusEnum? status = default(StatusEnum?), string message = default(string))
        {
        ...
        public List<ExtendedGeofence> Data { get; set; }
        ...
        {
            return this.Equals(input as ApiResponseForPaginatedListExtendedGeofence);
        }

        /// <summary>
        /// Returns true if ApiResponseForPaginatedListExtendedGeofence instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseForPaginatedListExtendedGeofence to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseForPaginatedListExtendedGeofence input)
        {
            if (input == null)
                return false;
