...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    public partial class CsApiOrgReportTrip :  IEquatable<CsApiOrgReportTrip>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CsApiOrgReportTrip" /> class.
        /// </summary>
        ...
        public CsApiOrgReportTrip(string Username = default(string), string EmailAddress = default(string), string FirstName = default(string), string LastName = default(string), int? TripId = default(int?), int? TimesheetId = default(int?), int? VehicleId = default(int?), int? UserId = default(int?), int? OrgId = default(int?), MobilePlatformEnum? MobilePlatform = default(MobilePlatformEnum?), DateTime? StartDate = default(DateTime?), DateTime? EndDate = default(DateTime?), string VehicleName = default(string), string VehicleMake = default(string), string VehicleModel = default(string), string VehicleYear = default(string), double? CostPerKilometer = default(double?), double? TripTotalCost = default(double?), double? TotalTripDistanceMeters = default(double?), string StartAddress = default(string), string EndAddress = default(string), List<CsApiTripCoordinate> PathCoordinates = default(List<CsApiTripCoordinate>), DateTime? CacheExpiryDate = default(DateTime?))
        {
        ...
        public List<CsApiTripCoordinate> PathCoordinates { get; set; }
        ...
        {
            return this.Equals(input as CsApiOrgReportTrip);
        }

        /// <summary>
        /// Returns true if CsApiOrgReportTrip instances are equal
        /// </summary>
        /// <param name="input">Instance of CsApiOrgReportTrip to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CsApiOrgReportTrip input)
        {
            if (input == null)
                return false;
