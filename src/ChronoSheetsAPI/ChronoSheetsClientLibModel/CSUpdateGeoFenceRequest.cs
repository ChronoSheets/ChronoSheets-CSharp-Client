...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class CSUpdateGeoFenceRequest :  IEquatable<CSUpdateGeoFenceRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CSUpdateGeoFenceRequest" /> class.
        /// </summary>
        ...
        public CSUpdateGeoFenceRequest(int? geofenceId = default(int?), string name = default(string), List<CSBasicCoordinate> fenceCoordinates = default(List<CSBasicCoordinate>), int? triggerJobCodeId = default(int?), int? triggerTaskId = default(int?), int? sendAlertToOrgGroupId = default(int?), AlertSettingsEnum? alertSettings = default(AlertSettingsEnum?), TriggerSettingsEnum? triggerSettings = default(TriggerSettingsEnum?), int? startTimeHour = default(int?), int? startTimeMinute = default(int?), int? endTimeHour = default(int?), int? endTimeMinute = default(int?))
        {
        ...
        public List<CSBasicCoordinate> FenceCoordinates { get; set; }
        ...
        {
            return this.Equals(input as CSUpdateGeoFenceRequest);
        }

        /// <summary>
        /// Returns true if CSUpdateGeoFenceRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CSUpdateGeoFenceRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CSUpdateGeoFenceRequest input)
        {
            if (input == null)
                return false;
