...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    public partial class CSApiResponseDoLoginResponse :  IEquatable<CSApiResponseDoLoginResponse>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as CSApiResponseDoLoginResponse);
        }

        /// <summary>
        /// Returns true if CSApiResponseDoLoginResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CSApiResponseDoLoginResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CSApiResponseDoLoginResponse input)
        {
            if (input == null)
                return false;
