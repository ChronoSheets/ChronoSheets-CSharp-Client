...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class ClientTotalsReportItem :  IEquatable<ClientTotalsReportItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientTotalsReportItem" /> class.
        /// </summary>
        ...
        public ClientTotalsReportItem(int organisationId = default(int), int userId = default(int), int clientId = default(int), string clientName = default(string), int spanSeconds = default(int))
        {
        ...
        {
            return this.Equals(input as ClientTotalsReportItem);
        }

        /// <summary>
        /// Returns true if ClientTotalsReportItem instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientTotalsReportItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientTotalsReportItem input)
        {
            if (input == null)
                return false;
