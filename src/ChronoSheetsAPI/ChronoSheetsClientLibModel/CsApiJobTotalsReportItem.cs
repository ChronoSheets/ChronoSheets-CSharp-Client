...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class CsApiJobTotalsReportItem :  IEquatable<CsApiJobTotalsReportItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CsApiJobTotalsReportItem" /> class.
        /// </summary>
        ...
        public CsApiJobTotalsReportItem(int? OrganisationId = default(int?), int? JobId = default(int?), string JobCode = default(string), int? ClientId = default(int?), string ClientName = default(string), int? ProjectId = default(int?), string ProjectName = default(string), int? SpanSeconds = default(int?))
        {
        ...
        {
            return this.Equals(input as CsApiJobTotalsReportItem);
        }

        /// <summary>
        /// Returns true if CsApiJobTotalsReportItem instances are equal
        /// </summary>
        /// <param name="input">Instance of CsApiJobTotalsReportItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CsApiJobTotalsReportItem input)
        {
            if (input == null)
                return false;
