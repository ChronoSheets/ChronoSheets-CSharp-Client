...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class ClientSideUser :  IEquatable<ClientSideUser>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientSideUser" /> class.
        /// </summary>
        ...
        public ClientSideUser(int id = default(int), int organisationId = default(int), string userName = default(string), string firstName = default(string), string lastName = default(string), string emailAddress = default(string), long roles = default(long), long alertSettings = default(long), bool setupWizardRequired = default(bool), bool isSubscribedToNewsletter = default(bool), Organisation organisation = default(Organisation), bool isPrimaryAccount = default(bool))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as ClientSideUser);
        }

        /// <summary>
        /// Returns true if ClientSideUser instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientSideUser to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientSideUser input)
        {
            if (input == null)
                return false;
