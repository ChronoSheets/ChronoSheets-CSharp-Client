...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class CSApiResponseForPaginatedListRawReportItem :  IEquatable<CSApiResponseForPaginatedListRawReportItem>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CSApiResponseForPaginatedListRawReportItem" /> class.
        /// </summary>
        ...
        public CSApiResponseForPaginatedListRawReportItem(int? totalSetCount = default(int?), List<CSRawReportItem> data = default(List<CSRawReportItem>), StatusEnum? status = default(StatusEnum?), string message = default(string))
        {
        ...
        public List<CSRawReportItem> Data { get; set; }
        ...
        {
            return this.Equals(input as CSApiResponseForPaginatedListRawReportItem);
        }

        /// <summary>
        /// Returns true if CSApiResponseForPaginatedListRawReportItem instances are equal
        /// </summary>
        /// <param name="input">Instance of CSApiResponseForPaginatedListRawReportItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CSApiResponseForPaginatedListRawReportItem input)
        {
            if (input == null)
                return false;
