...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class CsApiAggregateJobCode :  IEquatable<CsApiAggregateJobCode>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CsApiAggregateJobCode" /> class.
        /// </summary>
        ...
        public CsApiAggregateJobCode(List<CsApiAggregateJobTask> AvailableTasks = default(List<CsApiAggregateJobTask>), List<int?> PermittedEmployees = default(List<int?>), int? Id = default(int?), string Code = default(string), string _Client = default(string), int? ClientId = default(int?), string Project = default(string), int? ProjectId = default(int?), int? OrganisationId = default(int?), bool? IsDeleted = default(bool?))
        {
        ...
        public List<CsApiAggregateJobTask> AvailableTasks { get; set; }
        ...
        {
            return this.Equals(input as CsApiAggregateJobCode);
        }

        /// <summary>
        /// Returns true if CsApiAggregateJobCode instances are equal
        /// </summary>
        /// <param name="input">Instance of CsApiAggregateJobCode to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CsApiAggregateJobCode input)
        {
            if (input == null)
                return false;
