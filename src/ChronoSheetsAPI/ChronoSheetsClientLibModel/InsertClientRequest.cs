...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class InsertClientRequest :  IEquatable<InsertClientRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InsertClientRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as InsertClientRequest);
        }

        /// <summary>
        /// Returns true if InsertClientRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of InsertClientRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InsertClientRequest input)
        {
            if (input == null)
                return false;
