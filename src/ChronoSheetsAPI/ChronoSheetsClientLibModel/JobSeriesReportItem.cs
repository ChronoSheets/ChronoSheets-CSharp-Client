...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class JobSeriesReportItem :  IEquatable<JobSeriesReportItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JobSeriesReportItem" /> class.
        /// </summary>
        ...
        public JobSeriesReportItem(DateTime startDate = default(DateTime), DateTime endDate = default(DateTime), int jobId = default(int), int clientId = default(int), string clientName = default(string), int projectId = default(int), string projectName = default(string), int spanSeconds = default(int), string jobCode = default(string))
        {
        ...
        {
            return this.Equals(input as JobSeriesReportItem);
        }

        /// <summary>
        /// Returns true if JobSeriesReportItem instances are equal
        /// </summary>
        /// <param name="input">Instance of JobSeriesReportItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JobSeriesReportItem input)
        {
            if (input == null)
                return false;
