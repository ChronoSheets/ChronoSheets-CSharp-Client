...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class CsApiApiResponseForPaginatedListTrip :  IEquatable<CsApiApiResponseForPaginatedListTrip>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CsApiApiResponseForPaginatedListTrip" /> class.
        /// </summary>
        /// <param name="TotalSetCount">TotalSetCount.</param>
        /// <param name="Data">Data.</param>
        /// <param name="Status">Status.</param>
        /// <param name="Message">Message.</param>
        public CsApiApiResponseForPaginatedListTrip(int? TotalSetCount = default(int?), List<CsApiTrip> Data = default(List<CsApiTrip>), StatusEnum? Status = default(StatusEnum?), string Message = default(string))
        {
        ...
        public List<CsApiTrip> Data { get; set; }
        ...
        {
            return this.Equals(input as CsApiApiResponseForPaginatedListTrip);
        }

        /// <summary>
        /// Returns true if CsApiApiResponseForPaginatedListTrip instances are equal
        /// </summary>
        /// <param name="input">Instance of CsApiApiResponseForPaginatedListTrip to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CsApiApiResponseForPaginatedListTrip input)
        {
            if (input == null)
                return false;
