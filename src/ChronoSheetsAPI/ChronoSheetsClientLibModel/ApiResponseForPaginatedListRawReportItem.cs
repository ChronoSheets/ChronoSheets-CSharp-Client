...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseForPaginatedListRawReportItem :  IEquatable<ApiResponseForPaginatedListRawReportItem>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseForPaginatedListRawReportItem" /> class.
        /// </summary>
        ...
        public ApiResponseForPaginatedListRawReportItem(int totalSetCount = default(int), List<RawReportItem> data = default(List<RawReportItem>), StatusEnum? status = default(StatusEnum?), string message = default(string))
        {
        ...
        public List<RawReportItem> Data { get; set; }
        ...
        {
            return this.Equals(input as ApiResponseForPaginatedListRawReportItem);
        }

        /// <summary>
        /// Returns true if ApiResponseForPaginatedListRawReportItem instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseForPaginatedListRawReportItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseForPaginatedListRawReportItem input)
        {
            if (input == null)
                return false;
