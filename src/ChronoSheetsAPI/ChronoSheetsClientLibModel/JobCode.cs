...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class JobCode :  IEquatable<JobCode>, IValidatableObject
    {
        /// <summary>
        ...
        public JobCode(int id = default(int), string code = default(string), string _client = default(string), int clientId = default(int), string project = default(string), int projectId = default(int), int organisationId = default(int), bool isDeleted = default(bool))
        {
            this.Id = id;
            this.Code = code;
        ...
        {
            return this.Equals(input as JobCode);
        }

        /// <summary>
        /// Returns true if JobCode instances are equal
        /// </summary>
        /// <param name="input">Instance of JobCode to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JobCode input)
        {
            if (input == null)
                return false;
