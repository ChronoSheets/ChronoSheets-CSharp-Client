...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    public partial class CsApiApiResponseListOrganisationGroup :  IEquatable<CsApiApiResponseListOrganisationGroup>, IValidatableObject
    {
        ...
        public List<CsApiOrganisationGroup> Data { get; set; }
        ...
        {
            return this.Equals(input as CsApiApiResponseListOrganisationGroup);
        }

        /// <summary>
        /// Returns true if CsApiApiResponseListOrganisationGroup instances are equal
        /// </summary>
        /// <param name="input">Instance of CsApiApiResponseListOrganisationGroup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CsApiApiResponseListOrganisationGroup input)
        {
            if (input == null)
                return false;
