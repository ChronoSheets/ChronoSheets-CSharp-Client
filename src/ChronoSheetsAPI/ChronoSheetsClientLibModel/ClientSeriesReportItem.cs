...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class ClientSeriesReportItem :  IEquatable<ClientSeriesReportItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientSeriesReportItem" /> class.
        /// </summary>
        ...
        public ClientSeriesReportItem(DateTime startDate = default(DateTime), DateTime endDate = default(DateTime), int clientId = default(int), string clientName = default(string), int spanSeconds = default(int))
        {
        ...
        {
            return this.Equals(input as ClientSeriesReportItem);
        }

        /// <summary>
        /// Returns true if ClientSeriesReportItem instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientSeriesReportItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientSeriesReportItem input)
        {
            if (input == null)
                return false;
