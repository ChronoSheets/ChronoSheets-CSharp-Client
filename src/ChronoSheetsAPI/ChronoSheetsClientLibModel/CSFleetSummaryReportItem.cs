...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class CSFleetSummaryReportItem :  IEquatable<CSFleetSummaryReportItem>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CSFleetSummaryReportItem);
        }

        /// <summary>
        /// Returns true if CSFleetSummaryReportItem instances are equal
        /// </summary>
        /// <param name="input">Instance of CSFleetSummaryReportItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CSFleetSummaryReportItem input)
        {
            if (input == null)
                return false;
