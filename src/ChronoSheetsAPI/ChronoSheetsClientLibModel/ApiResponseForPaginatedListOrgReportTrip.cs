...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseForPaginatedListOrgReportTrip :  IEquatable<ApiResponseForPaginatedListOrgReportTrip>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseForPaginatedListOrgReportTrip" /> class.
        /// </summary>
        ...
        public ApiResponseForPaginatedListOrgReportTrip(int totalSetCount = default(int), List<OrgReportTrip> data = default(List<OrgReportTrip>), StatusEnum? status = default(StatusEnum?), string message = default(string))
        {
        ...
        public List<OrgReportTrip> Data { get; set; }
        ...
        {
            return this.Equals(input as ApiResponseForPaginatedListOrgReportTrip);
        }

        /// <summary>
        /// Returns true if ApiResponseForPaginatedListOrgReportTrip instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseForPaginatedListOrgReportTrip to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseForPaginatedListOrgReportTrip input)
        {
            if (input == null)
                return false;
