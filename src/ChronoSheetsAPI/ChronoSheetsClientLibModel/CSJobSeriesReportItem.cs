...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class CSJobSeriesReportItem :  IEquatable<CSJobSeriesReportItem>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CSJobSeriesReportItem);
        }

        /// <summary>
        /// Returns true if CSJobSeriesReportItem instances are equal
        /// </summary>
        /// <param name="input">Instance of CSJobSeriesReportItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CSJobSeriesReportItem input)
        {
            if (input == null)
                return false;
