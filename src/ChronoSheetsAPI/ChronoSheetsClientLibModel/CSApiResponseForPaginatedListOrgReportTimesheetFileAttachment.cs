...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class CSApiResponseForPaginatedListOrgReportTimesheetFileAttachment :  IEquatable<CSApiResponseForPaginatedListOrgReportTimesheetFileAttachment>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CSApiResponseForPaginatedListOrgReportTimesheetFileAttachment" /> class.
        /// </summary>
        ...
        public CSApiResponseForPaginatedListOrgReportTimesheetFileAttachment(int? totalSetCount = default(int?), List<CSOrgReportTimesheetFileAttachment> data = default(List<CSOrgReportTimesheetFileAttachment>), StatusEnum? status = default(StatusEnum?), string message = default(string))
        {
        ...
        public List<CSOrgReportTimesheetFileAttachment> Data { get; set; }
        ...
        {
            return this.Equals(input as CSApiResponseForPaginatedListOrgReportTimesheetFileAttachment);
        }

        /// <summary>
        /// Returns true if CSApiResponseForPaginatedListOrgReportTimesheetFileAttachment instances are equal
        /// </summary>
        /// <param name="input">Instance of CSApiResponseForPaginatedListOrgReportTimesheetFileAttachment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CSApiResponseForPaginatedListOrgReportTimesheetFileAttachment input)
        {
            if (input == null)
                return false;
