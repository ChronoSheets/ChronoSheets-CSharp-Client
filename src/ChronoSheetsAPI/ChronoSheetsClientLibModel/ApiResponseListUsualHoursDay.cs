...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseListUsualHoursDay :  IEquatable<ApiResponseListUsualHoursDay>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseListUsualHoursDay" /> class.
        /// </summary>
        ...
        public ApiResponseListUsualHoursDay(List<UsualHoursDay> data = default(List<UsualHoursDay>), StatusEnum? status = default(StatusEnum?), string message = default(string))
        {
            this.Data = data;
            this.Status = status;
        ...
        public List<UsualHoursDay> Data { get; set; }
        ...
        {
            return this.Equals(input as ApiResponseListUsualHoursDay);
        }

        /// <summary>
        /// Returns true if ApiResponseListUsualHoursDay instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseListUsualHoursDay to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseListUsualHoursDay input)
        {
            if (input == null)
                return false;
