...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class CSInsertProjectRequest :  IEquatable<CSInsertProjectRequest>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CSInsertProjectRequest);
        }

        /// <summary>
        /// Returns true if CSInsertProjectRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CSInsertProjectRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CSInsertProjectRequest input)
        {
            if (input == null)
                return false;
