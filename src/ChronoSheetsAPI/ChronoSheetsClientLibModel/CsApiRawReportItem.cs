...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class CsApiRawReportItem :  IEquatable<CsApiRawReportItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CsApiRawReportItem" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CsApiRawReportItem);
        }

        /// <summary>
        /// Returns true if CsApiRawReportItem instances are equal
        /// </summary>
        /// <param name="input">Instance of CsApiRawReportItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CsApiRawReportItem input)
        {
            if (input == null)
                return false;
