...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class CSSaveVehicleRequest :  IEquatable<CSSaveVehicleRequest>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CSSaveVehicleRequest);
        }

        /// <summary>
        /// Returns true if CSSaveVehicleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CSSaveVehicleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CSSaveVehicleRequest input)
        {
            if (input == null)
                return false;
