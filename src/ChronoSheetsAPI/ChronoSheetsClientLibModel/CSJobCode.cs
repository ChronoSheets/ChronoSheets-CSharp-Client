...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class CSJobCode :  IEquatable<CSJobCode>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CSJobCode);
        }

        /// <summary>
        /// Returns true if CSJobCode instances are equal
        /// </summary>
        /// <param name="input">Instance of CSJobCode to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CSJobCode input)
        {
            if (input == null)
                return false;
