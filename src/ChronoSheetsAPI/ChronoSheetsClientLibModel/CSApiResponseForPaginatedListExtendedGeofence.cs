...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class CSApiResponseForPaginatedListExtendedGeofence :  IEquatable<CSApiResponseForPaginatedListExtendedGeofence>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CSApiResponseForPaginatedListExtendedGeofence" /> class.
        /// </summary>
        ...
        public CSApiResponseForPaginatedListExtendedGeofence(int? totalSetCount = default(int?), List<CSExtendedGeofence> data = default(List<CSExtendedGeofence>), StatusEnum? status = default(StatusEnum?), string message = default(string))
        {
        ...
        public List<CSExtendedGeofence> Data { get; set; }
        ...
        {
            return this.Equals(input as CSApiResponseForPaginatedListExtendedGeofence);
        }

        /// <summary>
        /// Returns true if CSApiResponseForPaginatedListExtendedGeofence instances are equal
        /// </summary>
        /// <param name="input">Instance of CSApiResponseForPaginatedListExtendedGeofence to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CSApiResponseForPaginatedListExtendedGeofence input)
        {
            if (input == null)
                return false;
