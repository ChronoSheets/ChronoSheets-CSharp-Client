...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class InsertUserRequest :  IEquatable<InsertUserRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InsertUserRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as InsertUserRequest);
        }

        /// <summary>
        /// Returns true if InsertUserRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of InsertUserRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InsertUserRequest input)
        {
            if (input == null)
                return false;
