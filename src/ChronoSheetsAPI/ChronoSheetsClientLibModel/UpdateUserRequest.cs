...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    public partial class UpdateUserRequest :  IEquatable<UpdateUserRequest>, IValidatableObject
    {
        ...
        public UpdateUserRequest(int userId = default(int), string emailAddress = default(string), string firstName = default(string), string lastName = default(string), bool isSubscribedToNewsletter = default(bool), bool isAccountActive = default(bool), long roles = default(long), long alertSettings = default(long))
        {
            this.UserId = userId;
