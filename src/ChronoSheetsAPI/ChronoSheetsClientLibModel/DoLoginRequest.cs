...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class DoLoginRequest :  IEquatable<DoLoginRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DoLoginRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as DoLoginRequest);
        }

        /// <summary>
        /// Returns true if DoLoginRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DoLoginRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DoLoginRequest input)
        {
            if (input == null)
                return false;
