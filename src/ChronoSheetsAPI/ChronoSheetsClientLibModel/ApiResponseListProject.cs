...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseListProject :  IEquatable<ApiResponseListProject>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseListProject" /> class.
        /// </summary>
        ...
        public ApiResponseListProject(List<Project> data = default(List<Project>), StatusEnum? status = default(StatusEnum?), string message = default(string))
        {
            this.Data = data;
            this.Status = status;
        ...
        {
            return this.Equals(input as ApiResponseListProject);
        }

        /// <summary>
        /// Returns true if ApiResponseListProject instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseListProject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseListProject input)
        {
            if (input == null)
                return false;
