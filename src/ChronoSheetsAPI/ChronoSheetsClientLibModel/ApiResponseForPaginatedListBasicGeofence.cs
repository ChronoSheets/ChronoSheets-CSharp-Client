...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseForPaginatedListBasicGeofence :  IEquatable<ApiResponseForPaginatedListBasicGeofence>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseForPaginatedListBasicGeofence" /> class.
        /// </summary>
        ...
        public ApiResponseForPaginatedListBasicGeofence(int totalSetCount = default(int), List<BasicGeofence> data = default(List<BasicGeofence>), StatusEnum? status = default(StatusEnum?), string message = default(string))
        {
        ...
        public List<BasicGeofence> Data { get; set; }
        ...
        {
            return this.Equals(input as ApiResponseForPaginatedListBasicGeofence);
        }

        /// <summary>
        /// Returns true if ApiResponseForPaginatedListBasicGeofence instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseForPaginatedListBasicGeofence to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseForPaginatedListBasicGeofence input)
        {
            if (input == null)
                return false;
