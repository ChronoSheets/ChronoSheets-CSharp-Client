...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class CSTimesheetAutomationWithOrgAndGeofence :  IEquatable<CSTimesheetAutomationWithOrgAndGeofence>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CSTimesheetAutomationWithOrgAndGeofence" /> class.
        /// </summary>
        ...
        public CSTimesheetAutomationWithOrgAndGeofence(int? orgId = default(int?), string geofenceName = default(string), List<CSBasicCoordinate> coordinates = default(List<CSBasicCoordinate>), int? userId = default(int?), string userName = default(string), string firstName = default(string), string lastName = default(string), int? automationId = default(int?), AutomationActionTypeEnum? automationActionType = default(AutomationActionTypeEnum?), DateTime? created = default(DateTime?), double? latitude = default(double?), double? longitude = default(double?), bool? isProcessed = default(bool?), DateTime? expires = default(DateTime?), DateTime? clientDateTime = default(DateTime?))
        {
            this.OrgId = orgId;
        ...
        {
            return this.Equals(input as CSTimesheetAutomationWithOrgAndGeofence);
        }

        /// <summary>
        /// Returns true if CSTimesheetAutomationWithOrgAndGeofence instances are equal
        /// </summary>
        /// <param name="input">Instance of CSTimesheetAutomationWithOrgAndGeofence to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CSTimesheetAutomationWithOrgAndGeofence input)
        {
            if (input == null)
                return false;
