...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseForPaginatedListTrip :  IEquatable<ApiResponseForPaginatedListTrip>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseForPaginatedListTrip" /> class.
        /// </summary>
        ...
        public ApiResponseForPaginatedListTrip(int totalSetCount = default(int), List<Trip> data = default(List<Trip>), StatusEnum? status = default(StatusEnum?), string message = default(string))
        {
        ...
        {
            return this.Equals(input as ApiResponseForPaginatedListTrip);
        }

        /// <summary>
        /// Returns true if ApiResponseForPaginatedListTrip instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseForPaginatedListTrip to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseForPaginatedListTrip input)
        {
            if (input == null)
                return false;
