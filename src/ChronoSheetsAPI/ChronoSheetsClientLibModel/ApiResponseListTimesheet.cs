...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseListTimesheet :  IEquatable<ApiResponseListTimesheet>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseListTimesheet" /> class.
        /// </summary>
        ...
        public ApiResponseListTimesheet(List<Timesheet> data = default(List<Timesheet>), StatusEnum? status = default(StatusEnum?), string message = default(string))
        {
            this.Data = data;
            this.Status = status;
        ...
        {
            return this.Equals(input as ApiResponseListTimesheet);
        }

        /// <summary>
        /// Returns true if ApiResponseListTimesheet instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseListTimesheet to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseListTimesheet input)
        {
            if (input == null)
                return false;
