...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class InsertProjectRequest :  IEquatable<InsertProjectRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InsertProjectRequest" /> class.
        /// </summary>
        ...
        public InsertProjectRequest(int clientId = default(int), string projectName = default(string), double costEstimation = default(double), DateTime startDate = default(DateTime), DateTime endDate = default(DateTime))
        {
        ...
        /// </summary>
        /// <value>The Id of the Client that is associated with the new project</value>
        ...
        /// </summary>
        /// <value>The estimated cost of work to complete the project.  This value is used in the Organisation Reports view &#39;Project Costs&#39;</value>
        ...
        /// </summary>
        /// <value>The start date of the project.  When the project is due to start</value>
        ...
        /// </summary>
        /// <value>The end date of the project.  When the project is due to end</value>
        ...
        {
            return this.Equals(input as InsertProjectRequest);
        }

        /// <summary>
        /// Returns true if InsertProjectRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of InsertProjectRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InsertProjectRequest input)
        {
            if (input == null)
                return false;
