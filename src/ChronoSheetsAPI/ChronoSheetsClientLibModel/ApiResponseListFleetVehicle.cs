...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseListFleetVehicle :  IEquatable<ApiResponseListFleetVehicle>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseListFleetVehicle" /> class.
        /// </summary>
        ...
        public ApiResponseListFleetVehicle(List<FleetVehicle> data = default(List<FleetVehicle>), StatusEnum? status = default(StatusEnum?), string message = default(string))
        {
            this.Data = data;
            this.Status = status;
        ...
        public List<FleetVehicle> Data { get; set; }
        ...
        {
            return this.Equals(input as ApiResponseListFleetVehicle);
        }

        /// <summary>
        /// Returns true if ApiResponseListFleetVehicle instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseListFleetVehicle to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseListFleetVehicle input)
        {
            if (input == null)
                return false;
