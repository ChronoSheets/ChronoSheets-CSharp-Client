...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class InsertTaskRequest :  IEquatable<InsertTaskRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InsertTaskRequest" /> class.
        /// </summary>
        ...
        public InsertTaskRequest(string taskName = default(string), bool tripEnabled = default(bool))
        {
        ...
        {
            return this.Equals(input as InsertTaskRequest);
        }

        /// <summary>
        /// Returns true if InsertTaskRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of InsertTaskRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InsertTaskRequest input)
        {
            if (input == null)
                return false;
