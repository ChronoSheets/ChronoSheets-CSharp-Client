...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class Trip :  IEquatable<Trip>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as Trip);
        }

        /// <summary>
        /// Returns true if Trip instances are equal
        /// </summary>
        /// <param name="input">Instance of Trip to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Trip input)
        {
            if (input == null)
                return false;
