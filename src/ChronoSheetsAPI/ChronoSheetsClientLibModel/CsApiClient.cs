...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class CsApiClient :  IEquatable<CsApiClient>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CsApiClient" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CsApiClient);
        }

        /// <summary>
        /// Returns true if CsApiClient instances are equal
        /// </summary>
        /// <param name="input">Instance of CsApiClient to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CsApiClient input)
        {
            if (input == null)
                return false;
