...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class CSGeofence :  IEquatable<CSGeofence>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CSGeofence" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CSGeofence);
        }

        /// <summary>
        /// Returns true if CSGeofence instances are equal
        /// </summary>
        /// <param name="input">Instance of CSGeofence to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CSGeofence input)
        {
            if (input == null)
                return false;
