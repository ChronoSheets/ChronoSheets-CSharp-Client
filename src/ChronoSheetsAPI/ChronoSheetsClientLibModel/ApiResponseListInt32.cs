...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseListInt32 :  IEquatable<ApiResponseListInt32>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseListInt32" /> class.
        /// </summary>
        ...
        public ApiResponseListInt32(List<int> data = default(List<int>), StatusEnum? status = default(StatusEnum?), string message = default(string))
        {
            this.Data = data;
            this.Status = status;
        ...
        {
            return this.Equals(input as ApiResponseListInt32);
        }

        /// <summary>
        /// Returns true if ApiResponseListInt32 instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseListInt32 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseListInt32 input)
        {
            if (input == null)
                return false;
