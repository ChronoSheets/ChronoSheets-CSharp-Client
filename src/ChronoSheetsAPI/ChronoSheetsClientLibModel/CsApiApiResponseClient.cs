...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    public partial class CsApiApiResponseClient :  IEquatable<CsApiApiResponseClient>, IValidatableObject
    {
        ...
        public CsApiClient Data { get; set; }
        ...
        {
            return this.Equals(input as CsApiApiResponseClient);
        }

        /// <summary>
        /// Returns true if CsApiApiResponseClient instances are equal
        /// </summary>
        /// <param name="input">Instance of CsApiApiResponseClient to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CsApiApiResponseClient input)
        {
            if (input == null)
                return false;
