...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class CsApiProjectCostingReportItem :  IEquatable<CsApiProjectCostingReportItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CsApiProjectCostingReportItem" /> class.
        /// </summary>
        ...
        public CsApiProjectCostingReportItem(int? ProjectId = default(int?), string ProjectName = default(string), int? ClientId = default(int?), int? OrganisationId = default(int?), string ClientName = default(string), double? EstimatedCost = default(double?), double? ActualCost = default(double?))
        {
        ...
        {
            return this.Equals(input as CsApiProjectCostingReportItem);
        }

        /// <summary>
        /// Returns true if CsApiProjectCostingReportItem instances are equal
        /// </summary>
        /// <param name="input">Instance of CsApiProjectCostingReportItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CsApiProjectCostingReportItem input)
        {
            if (input == null)
                return false;
