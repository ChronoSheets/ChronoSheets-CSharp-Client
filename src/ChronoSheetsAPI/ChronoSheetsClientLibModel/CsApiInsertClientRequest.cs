...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class CsApiInsertClientRequest :  IEquatable<CsApiInsertClientRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CsApiInsertClientRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CsApiInsertClientRequest);
        }

        /// <summary>
        /// Returns true if CsApiInsertClientRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CsApiInsertClientRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CsApiInsertClientRequest input)
        {
            if (input == null)
                return false;
