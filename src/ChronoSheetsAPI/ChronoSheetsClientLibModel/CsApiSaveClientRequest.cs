...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class CsApiSaveClientRequest :  IEquatable<CsApiSaveClientRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CsApiSaveClientRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CsApiSaveClientRequest);
        }

        /// <summary>
        /// Returns true if CsApiSaveClientRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CsApiSaveClientRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CsApiSaveClientRequest input)
        {
            if (input == null)
                return false;
