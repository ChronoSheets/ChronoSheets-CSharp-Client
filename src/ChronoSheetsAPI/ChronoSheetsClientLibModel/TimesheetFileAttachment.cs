...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class TimesheetFileAttachment :  IEquatable<TimesheetFileAttachment>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TimesheetFileAttachment" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as TimesheetFileAttachment);
        }

        /// <summary>
        /// Returns true if TimesheetFileAttachment instances are equal
        /// </summary>
        /// <param name="input">Instance of TimesheetFileAttachment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TimesheetFileAttachment input)
        {
            if (input == null)
                return false;
