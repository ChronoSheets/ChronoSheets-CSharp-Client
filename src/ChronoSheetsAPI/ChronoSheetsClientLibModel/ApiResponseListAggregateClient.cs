...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseListAggregateClient :  IEquatable<ApiResponseListAggregateClient>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseListAggregateClient" /> class.
        /// </summary>
        ...
        public ApiResponseListAggregateClient(List<AggregateClient> data = default(List<AggregateClient>), StatusEnum? status = default(StatusEnum?), string message = default(string))
        {
            this.Data = data;
            this.Status = status;
        ...
        public List<AggregateClient> Data { get; set; }
        ...
        {
            return this.Equals(input as ApiResponseListAggregateClient);
        }

        /// <summary>
        /// Returns true if ApiResponseListAggregateClient instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseListAggregateClient to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseListAggregateClient input)
        {
            if (input == null)
                return false;
