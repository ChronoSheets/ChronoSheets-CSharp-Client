...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseUpdateUserResponse :  IEquatable<ApiResponseUpdateUserResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseUpdateUserResponse" /> class.
        /// </summary>
        ...
        public ApiResponseUpdateUserResponse(UpdateUserResponse data = default(UpdateUserResponse), StatusEnum? status = default(StatusEnum?), string message = default(string))
        {
            this.Data = data;
            this.Status = status;
        ...
        public UpdateUserResponse Data { get; set; }
        ...
        {
            return this.Equals(input as ApiResponseUpdateUserResponse);
        }

        /// <summary>
        /// Returns true if ApiResponseUpdateUserResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseUpdateUserResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseUpdateUserResponse input)
        {
            if (input == null)
                return false;
