...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class CSApiResponseOrganisation :  IEquatable<CSApiResponseOrganisation>, IValidatableObject
    {
        /// <summary>
        ...
        public CSOrganisation Data { get; set; }
        ...
        {
            return this.Equals(input as CSApiResponseOrganisation);
        }

        /// <summary>
        /// Returns true if CSApiResponseOrganisation instances are equal
        /// </summary>
        /// <param name="input">Instance of CSApiResponseOrganisation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CSApiResponseOrganisation input)
        {
            if (input == null)
                return false;
