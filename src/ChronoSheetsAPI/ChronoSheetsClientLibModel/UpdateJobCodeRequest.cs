...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateJobCodeRequest :  IEquatable<UpdateJobCodeRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateJobCodeRequest" /> class.
        /// </summary>
        ...
        public UpdateJobCodeRequest(int id = default(int), string code = default(string), int projectId = default(int), int clientId = default(int), List<int> linkedTaskIds = default(List<int>), List<int> linkedOrgGroupIds = default(List<int>), bool isDeleted = default(bool))
        {
            this.Id = id;
            this.Code = code;
        ...
        {
            return this.Equals(input as UpdateJobCodeRequest);
        }

        /// <summary>
        /// Returns true if UpdateJobCodeRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateJobCodeRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateJobCodeRequest input)
        {
            if (input == null)
                return false;
