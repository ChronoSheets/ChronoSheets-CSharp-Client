...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    public partial class CreateGeoFenceRequest :  IEquatable<CreateGeoFenceRequest>, IValidatableObject
    {
        ...
        public CreateGeoFenceRequest(string name = default(string), List<BasicCoordinate> fenceCoordinates = default(List<BasicCoordinate>), int triggerJobCodeId = default(int), int triggerTaskId = default(int), int sendAlertToOrgGroupId = default(int), AlertSettingsEnum? alertSettings = default(AlertSettingsEnum?), TriggerSettingsEnum? triggerSettings = default(TriggerSettingsEnum?), int startTimeHour = default(int), int startTimeMinute = default(int), int endTimeHour = default(int), int endTimeMinute = default(int))
        {
            this.Name = name;
