...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseListFleetSummaryReportItem :  IEquatable<ApiResponseListFleetSummaryReportItem>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseListFleetSummaryReportItem" /> class.
        /// </summary>
        ...
        public ApiResponseListFleetSummaryReportItem(List<FleetSummaryReportItem> data = default(List<FleetSummaryReportItem>), StatusEnum? status = default(StatusEnum?), string message = default(string))
        {
            this.Data = data;
            this.Status = status;
        ...
        public List<FleetSummaryReportItem> Data { get; set; }
        ...
        {
            return this.Equals(input as ApiResponseListFleetSummaryReportItem);
        }

        /// <summary>
        /// Returns true if ApiResponseListFleetSummaryReportItem instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseListFleetSummaryReportItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseListFleetSummaryReportItem input)
        {
            if (input == null)
                return false;
