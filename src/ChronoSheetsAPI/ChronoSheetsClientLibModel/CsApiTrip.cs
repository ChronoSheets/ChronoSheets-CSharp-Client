...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class CsApiTrip :  IEquatable<CsApiTrip>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CsApiTrip" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CsApiTrip);
        }

        /// <summary>
        /// Returns true if CsApiTrip instances are equal
        /// </summary>
        /// <param name="input">Instance of CsApiTrip to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CsApiTrip input)
        {
            if (input == null)
                return false;
