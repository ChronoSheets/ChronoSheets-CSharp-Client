...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserHourlyRate :  IEquatable<UserHourlyRate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserHourlyRate" /> class.
        /// </summary>
        ...
        public UserHourlyRate(int rateId = default(int), int userId = default(int), int organisationId = default(int), bool isCurrent = default(bool), double hourlyRate = default(double), double hourlyOvertimeRate = default(double), DateTime startDateTime = default(DateTime), DateTime endDateTime = default(DateTime))
        {
            this.RateId = rateId;
            this.UserId = userId;
        ...
        {
            return this.Equals(input as UserHourlyRate);
        }

        /// <summary>
        /// Returns true if UserHourlyRate instances are equal
        /// </summary>
        /// <param name="input">Instance of UserHourlyRate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserHourlyRate input)
        {
            if (input == null)
                return false;
