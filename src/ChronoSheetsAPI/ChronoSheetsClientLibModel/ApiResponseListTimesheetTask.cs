...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseListTimesheetTask :  IEquatable<ApiResponseListTimesheetTask>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseListTimesheetTask" /> class.
        /// </summary>
        ...
        public ApiResponseListTimesheetTask(List<TimesheetTask> data = default(List<TimesheetTask>), StatusEnum? status = default(StatusEnum?), string message = default(string))
        {
            this.Data = data;
            this.Status = status;
        ...
        public List<TimesheetTask> Data { get; set; }
        ...
        {
            return this.Equals(input as ApiResponseListTimesheetTask);
        }

        /// <summary>
        /// Returns true if ApiResponseListTimesheetTask instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseListTimesheetTask to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseListTimesheetTask input)
        {
            if (input == null)
                return false;
