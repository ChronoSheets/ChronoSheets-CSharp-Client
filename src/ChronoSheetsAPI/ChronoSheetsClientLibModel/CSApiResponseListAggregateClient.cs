...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class CSApiResponseListAggregateClient :  IEquatable<CSApiResponseListAggregateClient>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CSApiResponseListAggregateClient" /> class.
        /// </summary>
        ...
        public CSApiResponseListAggregateClient(List<CSAggregateClient> data = default(List<CSAggregateClient>), StatusEnum? status = default(StatusEnum?), string message = default(string))
        {
            this.Data = data;
            this.Status = status;
        ...
        public List<CSAggregateClient> Data { get; set; }
        ...
        {
            return this.Equals(input as CSApiResponseListAggregateClient);
        }

        /// <summary>
        /// Returns true if CSApiResponseListAggregateClient instances are equal
        /// </summary>
        /// <param name="input">Instance of CSApiResponseListAggregateClient to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CSApiResponseListAggregateClient input)
        {
            if (input == null)
                return false;
