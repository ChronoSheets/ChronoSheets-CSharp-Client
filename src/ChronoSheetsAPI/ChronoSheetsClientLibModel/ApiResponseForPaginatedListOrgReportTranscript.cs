...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseForPaginatedListOrgReportTranscript :  IEquatable<ApiResponseForPaginatedListOrgReportTranscript>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseForPaginatedListOrgReportTranscript" /> class.
        /// </summary>
        ...
        public ApiResponseForPaginatedListOrgReportTranscript(int totalSetCount = default(int), List<OrgReportTranscript> data = default(List<OrgReportTranscript>), StatusEnum? status = default(StatusEnum?), string message = default(string))
        {
        ...
        public List<OrgReportTranscript> Data { get; set; }
        ...
        {
            return this.Equals(input as ApiResponseForPaginatedListOrgReportTranscript);
        }

        /// <summary>
        /// Returns true if ApiResponseForPaginatedListOrgReportTranscript instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseForPaginatedListOrgReportTranscript to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseForPaginatedListOrgReportTranscript input)
        {
            if (input == null)
                return false;
