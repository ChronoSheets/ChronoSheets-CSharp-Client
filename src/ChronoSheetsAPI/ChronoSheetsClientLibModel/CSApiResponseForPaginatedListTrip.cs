...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class CSApiResponseForPaginatedListTrip :  IEquatable<CSApiResponseForPaginatedListTrip>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CSApiResponseForPaginatedListTrip" /> class.
        /// </summary>
        ...
        public CSApiResponseForPaginatedListTrip(int? totalSetCount = default(int?), List<CSTrip> data = default(List<CSTrip>), StatusEnum? status = default(StatusEnum?), string message = default(string))
        {
        ...
        public List<CSTrip> Data { get; set; }
        ...
        {
            return this.Equals(input as CSApiResponseForPaginatedListTrip);
        }

        /// <summary>
        /// Returns true if CSApiResponseForPaginatedListTrip instances are equal
        /// </summary>
        /// <param name="input">Instance of CSApiResponseForPaginatedListTrip to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CSApiResponseForPaginatedListTrip input)
        {
            if (input == null)
                return false;
