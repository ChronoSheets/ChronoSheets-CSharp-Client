...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseUserProfile :  IEquatable<ApiResponseUserProfile>, IValidatableObject
    {
        /// <summary>
        ...
        public ApiResponseUserProfile(UserProfile data = default(UserProfile), StatusEnum? status = default(StatusEnum?), string message = default(string))
        {
            this.Data = data;
            this.Status = status;
        ...
        {
            return this.Equals(input as ApiResponseUserProfile);
        }

        /// <summary>
        /// Returns true if ApiResponseUserProfile instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseUserProfile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseUserProfile input)
        {
            if (input == null)
                return false;
