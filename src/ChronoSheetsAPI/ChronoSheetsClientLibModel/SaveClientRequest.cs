...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class SaveClientRequest :  IEquatable<SaveClientRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SaveClientRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as SaveClientRequest);
        }

        /// <summary>
        /// Returns true if SaveClientRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SaveClientRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SaveClientRequest input)
        {
            if (input == null)
                return false;
