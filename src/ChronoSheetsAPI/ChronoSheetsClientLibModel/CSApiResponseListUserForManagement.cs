...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class CSApiResponseListUserForManagement :  IEquatable<CSApiResponseListUserForManagement>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CSApiResponseListUserForManagement" /> class.
        /// </summary>
        ...
        public CSApiResponseListUserForManagement(List<CSUserForManagement> data = default(List<CSUserForManagement>), StatusEnum? status = default(StatusEnum?), string message = default(string))
        {
            this.Data = data;
            this.Status = status;
        ...
        public List<CSUserForManagement> Data { get; set; }
        ...
        {
            return this.Equals(input as CSApiResponseListUserForManagement);
        }

        /// <summary>
        /// Returns true if CSApiResponseListUserForManagement instances are equal
        /// </summary>
        /// <param name="input">Instance of CSApiResponseListUserForManagement to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CSApiResponseListUserForManagement input)
        {
            if (input == null)
                return false;
