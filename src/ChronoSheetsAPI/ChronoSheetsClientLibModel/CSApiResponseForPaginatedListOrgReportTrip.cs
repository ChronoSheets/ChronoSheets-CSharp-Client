...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class CSApiResponseForPaginatedListOrgReportTrip :  IEquatable<CSApiResponseForPaginatedListOrgReportTrip>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CSApiResponseForPaginatedListOrgReportTrip" /> class.
        /// </summary>
        ...
        public CSApiResponseForPaginatedListOrgReportTrip(int? totalSetCount = default(int?), List<CSOrgReportTrip> data = default(List<CSOrgReportTrip>), StatusEnum? status = default(StatusEnum?), string message = default(string))
        {
        ...
        public List<CSOrgReportTrip> Data { get; set; }
        ...
        {
            return this.Equals(input as CSApiResponseForPaginatedListOrgReportTrip);
        }

        /// <summary>
        /// Returns true if CSApiResponseForPaginatedListOrgReportTrip instances are equal
        /// </summary>
        /// <param name="input">Instance of CSApiResponseForPaginatedListOrgReportTrip to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CSApiResponseForPaginatedListOrgReportTrip input)
        {
            if (input == null)
                return false;
