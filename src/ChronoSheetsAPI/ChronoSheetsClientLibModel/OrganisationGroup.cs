...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    public partial class OrganisationGroup :  IEquatable<OrganisationGroup>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as OrganisationGroup);
        }

        /// <summary>
        /// Returns true if OrganisationGroup instances are equal
        /// </summary>
        /// <param name="input">Instance of OrganisationGroup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrganisationGroup input)
        {
            if (input == null)
                return false;
