...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    public partial class CsApiOrgReportTimesheetFileAttachment :  IEquatable<CsApiOrgReportTimesheetFileAttachment>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CsApiOrgReportTimesheetFileAttachment" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CsApiOrgReportTimesheetFileAttachment);
        }

        /// <summary>
        /// Returns true if CsApiOrgReportTimesheetFileAttachment instances are equal
        /// </summary>
        /// <param name="input">Instance of CsApiOrgReportTimesheetFileAttachment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CsApiOrgReportTimesheetFileAttachment input)
        {
            if (input == null)
                return false;
