...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseUserForManagement :  IEquatable<ApiResponseUserForManagement>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseUserForManagement" /> class.
        /// </summary>
        ...
        public ApiResponseUserForManagement(UserForManagement data = default(UserForManagement), StatusEnum? status = default(StatusEnum?), string message = default(string))
        {
            this.Data = data;
            this.Status = status;
        ...
        public UserForManagement Data { get; set; }
        ...
        {
            return this.Equals(input as ApiResponseUserForManagement);
        }

        /// <summary>
        /// Returns true if ApiResponseUserForManagement instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseUserForManagement to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseUserForManagement input)
        {
            if (input == null)
                return false;
