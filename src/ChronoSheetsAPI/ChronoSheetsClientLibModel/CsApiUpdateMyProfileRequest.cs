...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class CsApiUpdateMyProfileRequest :  IEquatable<CsApiUpdateMyProfileRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CsApiUpdateMyProfileRequest" /> class.
        /// </summary>
        ...
        public CsApiUpdateMyProfileRequest(string EmailAddress = default(string), string FirstName = default(string), string LastName = default(string), string OldPassword = default(string), string NewPassword = default(string), string ConfirmNewPassword = default(string), bool? IsSubscribedToNewsletter = default(bool?), bool? WantsToChangePassword = default(bool?))
        {
        ...
        {
            return this.Equals(input as CsApiUpdateMyProfileRequest);
        }

        /// <summary>
        /// Returns true if CsApiUpdateMyProfileRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CsApiUpdateMyProfileRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CsApiUpdateMyProfileRequest input)
        {
            if (input == null)
                return false;
