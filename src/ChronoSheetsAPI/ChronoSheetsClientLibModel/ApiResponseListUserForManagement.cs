...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseListUserForManagement :  IEquatable<ApiResponseListUserForManagement>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseListUserForManagement" /> class.
        /// </summary>
        ...
        public ApiResponseListUserForManagement(List<UserForManagement> data = default(List<UserForManagement>), StatusEnum? status = default(StatusEnum?), string message = default(string))
        {
            this.Data = data;
            this.Status = status;
        ...
        public List<UserForManagement> Data { get; set; }
        ...
        {
            return this.Equals(input as ApiResponseListUserForManagement);
        }

        /// <summary>
        /// Returns true if ApiResponseListUserForManagement instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseListUserForManagement to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseListUserForManagement input)
        {
            if (input == null)
                return false;
