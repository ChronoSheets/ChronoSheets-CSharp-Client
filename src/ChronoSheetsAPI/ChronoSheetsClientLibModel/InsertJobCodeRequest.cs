...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class InsertJobCodeRequest :  IEquatable<InsertJobCodeRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InsertJobCodeRequest" /> class.
        /// </summary>
        ...
        public InsertJobCodeRequest(string code = default(string), int projectId = default(int), int clientId = default(int), List<int> linkedTaskIds = default(List<int>), List<int> linkedOrgGroupIds = default(List<int>))
        {
            this.Code = code;
        ...
        {
            return this.Equals(input as InsertJobCodeRequest);
        }

        /// <summary>
        /// Returns true if InsertJobCodeRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of InsertJobCodeRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InsertJobCodeRequest input)
        {
            if (input == null)
                return false;
