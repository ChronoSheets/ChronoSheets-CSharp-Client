...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseOrganisation :  IEquatable<ApiResponseOrganisation>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseOrganisation" /> class.
        /// </summary>
        ...
        public ApiResponseOrganisation(Organisation data = default(Organisation), StatusEnum? status = default(StatusEnum?), string message = default(string))
        {
            this.Data = data;
            this.Status = status;
        ...
        {
            return this.Equals(input as ApiResponseOrganisation);
        }

        /// <summary>
        /// Returns true if ApiResponseOrganisation instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseOrganisation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseOrganisation input)
        {
            if (input == null)
                return false;
