...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseListClient :  IEquatable<ApiResponseListClient>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseListClient" /> class.
        /// </summary>
        ...
        public ApiResponseListClient(List<ModelClient> data = default(List<ModelClient>), StatusEnum? status = default(StatusEnum?), string message = default(string))
        {
            this.Data = data;
            this.Status = status;
        ...
        {
            return this.Equals(input as ApiResponseListClient);
        }

        /// <summary>
        /// Returns true if ApiResponseListClient instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseListClient to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseListClient input)
        {
            if (input == null)
                return false;
