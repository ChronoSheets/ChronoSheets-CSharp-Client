...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class AggregateClient :  IEquatable<AggregateClient>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>A list of projects that are under this client</value>
        [DataMember(Name="ClientProjects", EmitDefaultValue=false)]
        public List<AggregateProject> ClientProjects { get; set; }
        ...
        {
            return this.Equals(input as AggregateClient);
        }

        /// <summary>
        /// Returns true if AggregateClient instances are equal
        /// </summary>
        /// <param name="input">Instance of AggregateClient to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AggregateClient input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.ClientProjects == input.ClientProjects ||
                    this.ClientProjects != null &&
                    input.ClientProjects != null &&
                    this.ClientProjects.SequenceEqual(input.ClientProjects)
                ) && 
                (
                    this.Id == input.Id ||
                    (this.Id != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ClientProjects != null)
                    hashCode = hashCode * 59 + this.ClientProjects.GetHashCode();
                if (this.Id != null)
