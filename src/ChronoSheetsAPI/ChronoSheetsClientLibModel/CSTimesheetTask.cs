...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class CSTimesheetTask :  IEquatable<CSTimesheetTask>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CSTimesheetTask);
        }

        /// <summary>
        /// Returns true if CSTimesheetTask instances are equal
        /// </summary>
        /// <param name="input">Instance of CSTimesheetTask to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CSTimesheetTask input)
        {
            if (input == null)
                return false;
