...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiResponseListUserHourlyRate :  IEquatable<ApiResponseListUserHourlyRate>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseListUserHourlyRate" /> class.
        /// </summary>
        ...
        public ApiResponseListUserHourlyRate(List<UserHourlyRate> data = default(List<UserHourlyRate>), StatusEnum? status = default(StatusEnum?), string message = default(string))
        {
            this.Data = data;
            this.Status = status;
        ...
        public List<UserHourlyRate> Data { get; set; }
        ...
        {
            return this.Equals(input as ApiResponseListUserHourlyRate);
        }

        /// <summary>
        /// Returns true if ApiResponseListUserHourlyRate instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiResponseListUserHourlyRate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseListUserHourlyRate input)
        {
            if (input == null)
                return false;
