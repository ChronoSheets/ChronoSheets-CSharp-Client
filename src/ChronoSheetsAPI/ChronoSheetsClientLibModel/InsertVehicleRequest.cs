...
namespace ChronoSheetsAPI.ChronoSheetsClientLibModel
{
    ...
    /// </summary>
    [DataContract]
    public partial class InsertVehicleRequest :  IEquatable<InsertVehicleRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InsertVehicleRequest" /> class.
        /// </summary>
        ...
        public InsertVehicleRequest(string name = default(string), double costPerKilometer = default(double), string make = default(string), string model = default(string), string year = default(string), string licencePlateNumber = default(string), List<int> linkedOrgGroupIds = default(List<int>))
        {
            this.Name = name;
        ...
        {
            return this.Equals(input as InsertVehicleRequest);
        }

        /// <summary>
        /// Returns true if InsertVehicleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of InsertVehicleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InsertVehicleRequest input)
        {
            if (input == null)
                return false;
