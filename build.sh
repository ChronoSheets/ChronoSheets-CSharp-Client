...
${nuget_cmd} install src/ChronoSheetsAPI/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/ChronoSheetsAPI.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/ChronoSheetsAPI.dll \
-recurse:'src/ChronoSheetsAPI/*.cs' \
-doc:bin/ChronoSheetsAPI.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/ChronoSheetsAPI.dll was created successfully"
fi
